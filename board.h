...
// Test Lamp
#define 	TEST_LAMP					PORTCbits.RC1
#define 	TEST_LAMP_DIRECTION			TRISCbits.RC1
...
#define SYSTEM_CLOCK			(32000000UL)	// Hz		// 10MHz external crystal x4 PLL
...
#define DISABLE_PORTB_INTERRUPT()	INTCONbits.RBIF = 0
#define ENABLE_PORTB_INTERRUPT()	INTCONbits.RBIF = 1
